#define NGX_CONFIGURE " --prefix=/opt/nginx --user=nginx --with-http_image_filter_module --add-module=../redis-nginx-module-0.3.7 --with-http_ssl_module --add-module=../ngx_devel_kit-0.2.19 --add-module=../set-misc-nginx-module-0.23"
